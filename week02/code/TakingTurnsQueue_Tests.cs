...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: None after fixing the turn re-enqueue logic
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: People with 0 turns were removed instead of being re-enqueued
    ...
    // Defect(s) Found: People with negative turns were removed instead of being re-enqueued
    ...
    // Defect(s) Found: None; the required exception and message are implemented 
